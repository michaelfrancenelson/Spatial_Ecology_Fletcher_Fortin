...
if (execute)
{
  if (save_images)
  {
    png(file.path(fig_dir, "varied_thrush_inset.png"),
        units = "in", height = map_panel_height, width = map_panel_width, res =  map_res)
    ...
    print(plot_grid(thrush_map + thrush_inset_poly, thrush_inset_map, nrow = 1))
    dev.off()
  }
}
